...
Song_recommend_temp = """You need to recommend the best song based on the genre which is{genre}. The user whom you are recommending this to has the mood {mood}"""
